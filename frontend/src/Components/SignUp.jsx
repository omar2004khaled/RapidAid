    ...
    <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden">
      <div className="flex-grow flex items-stretch">
        <div className="w-full grid grid-cols-1 md:grid-cols-2">
          ...
          {/* Right Panel - Form */}
          <div className="w-full flex items-center justify-center p-6 sm:p-8 lg:p-12 bg-gray-900">
            <div className="w-full max-w-md">
              <div className="mb-8 text-left">
                ...
                <h1 className="text-3xl font-black leading-tight tracking-[-0.033em] text-white">
                  Create Emergency System Account
                </h1>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <label className="flex flex-col w-full">
                  <p className="text-sm font-medium leading-normal pb-2 text-white">Username</p>
                  <input
                    name="username"
                    value={formData.username}
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={`form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-2 focus:ring-red-500/50 border ${
                      errors.username 
                        ? 'border-red-500'
                        : 'border-gray-600'
                    } bg-gray-800 focus:bg-gray-700 focus:border-red-500 h-12 placeholder:text-gray-400 px-4 text-base font-normal leading-normal`}
                ...
                {/* Full Name */}
                <label className="flex flex-col w-full">
                  <p className="text-sm font-medium leading-normal pb-2 text-white">Full Name</p>
                  <input
                    name="fullName"
                ...
                {/* Email */}
                <label className="flex flex-col w-full">
                  <p className="text-sm font-medium leading-normal pb-2 text-white">Email</p>
                  <input
                    name="email"
                    type="email"
                ...
                {/* Phone Number */}
                <label className="flex flex-col w-full">
                  <p className="text-sm font-medium leading-normal pb-2 text-white">Phone Number</p>
                  <input
                    name="phone"
                    type="tel"
                ...
                {/* Role */}
                <label className="flex flex-col w-full">
                  <p className="text-sm font-medium leading-normal pb-2 text-white">Role</p>
                  <select
                    name="role"
                    value={formData.role}
                    onChange={handleChange}
                    onBlur={handleBlur}
                    className={`form-select flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-2 focus:ring-red-500/50 border ${
                      errors.role 
                        ? 'border-red-500'
                        : 'border-gray-600'
                ...
                {/* Password */}
                <label className="flex flex-col w-full">
                <p className="text-sm font-medium leading-normal pb-2 text-white">Password</p>
                <div className="relative flex w-full flex-1 items-stretch">
                    ...
                    className={`form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-2 focus:ring-red-500/50 border ${
                        ...
                        ? 'border-red-500'
                        : 'border-gray-600'
                    } bg-gray-800 focus:bg-gray-700 focus:border-red-500 h-12 placeholder:text-gray-400 px-4 pr-12 text-base font-normal leading-normal`}
                ...
                {/* Confirm Password */}
                <label className="flex flex-col w-full">
                <p className="text-sm font-medium leading-normal pb-2 text-white">Confirm Password</p>
                <div className="relative flex w-full flex-1 items-stretch">
                    <input
                ...
                <div className="mt-6 flex flex-col gap-4">
                  <button 
                    type="submit" 
                    disabled={loading}
                    className="mt-4 w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white p-3 rounded-lg font-bold disabled:opacity-60 disabled:cursor-not-allowed transition-all flex items-center justify-center shadow-lg"
                  >
                    {loading ? (
                      <>
                  ...
                  <p className="text-center text-xs text-gray-400">
                    ...
                    <a className="font-medium text-red-400 hover:text-red-300 hover:underline" href="#">
                      Terms of Service
                    </a>{' '}
                    and{' '}
                    <a className="font-medium text-red-400 hover:text-red-300 hover:underline" href="#">
                ...
                <div className="mt-8 text-center">
                  <p className="text-sm text-gray-300">
                    ...
                    <a className="font-bold text-red-400 hover:text-red-300 hover:underline" href="/login">
                      Log In
                    </a>
                  </p>
                </div>
