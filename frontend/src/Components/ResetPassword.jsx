          ...
          {tokenValid ? (
            <>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="p-3 bg-gray-800 rounded-lg text-xs text-gray-300">
            ...
            <div className="flex flex-col gap-6 text-center">
              ...
              <div className="p-4 bg-gray-800 rounded-lg text-sm text-gray-300 text-left">
                <p>Reset links expire after 1 hour for security reasons. Please request a new password reset link.</p>
              </div>

              <Link
                to="/forgot-password"
                className="h-12 w-full flex items-center justify-center bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold rounded-lg transition-all shadow-lg"
              >
                Request New Link
              </Link>
            </div>
